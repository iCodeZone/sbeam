    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <form action="teamDeveLogin" method="post" class="form-horizontal">
                    <div class="form-group">
                        <label class="col-sm-4 control-label">请输入ID</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="ID" name="teamDeve.id" style="width: 100%;">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-4 control-label">请输入密码</label>
                        <div class="col-sm-8">
                            <input type="password" class="form-control" placeholder="密码" name="teamDeve.password" style="width: 100%;">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="teamDeveRegister.jsp">还没有账号？点此注册</a>
            </div>
        </div>
    </div>
</div>
